...
<div class="service_list">
    ...
    <div class="addbtn">
        <button class="btn btn-success col-3" onclick="switchadicion2('programacionadicion')">Nueva Sede <i class="fa-solid fa-circle-plus"></i></button>
    </div>
    ...
    <div id="programacionadicion" class="adicion_off" style="width:600px;height:400px">
        <div class="floatcontent">
            <h4 style="padding-top:5%;" >Nueva Programacion</h4> <hr>
