                    ...
                    <div class="main-sidevar-area">
                            ...
                            <div class="main-sidevar-item" id="seg_servdep">
                                ...
                                <div class="main-sidevar-item-links-off" id="servdeportivos">
                                    <a href={{ url('horario/listar') }}><button class="btn col-12" id="seg_servdep_sedes" name="sended" value="7">Horarios</button></a>
                                    ...
                                    <button  class="btn col-12" name="sended" value="10">Gestion de grupos</button>
                                    <button  class="btn col-12" name="sended" value="11">Gestion de deporitstas</button>
                                    <a href=" {{url('programacion/listar')}} "><button  class="btn col-12" name="sended" value="11">Gestion de programación</button></a>
                                </div>
                            </div>
